...
type UserActionType = {
    type: "LOGIN_SUCCESS" | "LOGIN_FAILURE" | "SIGN_OUT_SUCCESS" | "REFRESH_EXPIRED" | "CLEARLOGINERROR";
};
...
const authDispatchContext = createContext<Dispatch<UserActionType> | undefined>(undefined);
...
function loginUser({ authDispatch, login, password, navigate, setIsLoading }: LoginUserProps) {
    setIsLoading(true);
